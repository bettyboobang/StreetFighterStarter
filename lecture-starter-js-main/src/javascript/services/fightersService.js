...
class FighterService {
    ...
    async getFighterDetails(id) {
        console.log('1. Сервіс отримав ID:', id);
        try {
            ...
            console.log('2. Сервіс скачав дані:', apiResult);//calling the API helper function to fetch the fighter details from the specified endpoint
            return apiResult;
        } catch (error) {
